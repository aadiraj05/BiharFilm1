      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl font-bold text-[#891737] mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    {t("contactPage.address_line1")}
                    <br />
                    {t("contactPage.address_line2")}
                    <br />
                    {t("contactPage.address_line3")}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">0612-2219213</p>
                </div>
              </div>
